...
@ConfigurationProperties("landcms")
public class WallRideProperties {

	public static final String HOME_PROPERTY = "landcms.home";
	public static final String CONFIG_LOCATION_PROPERTY = "landcms.config-location";
	public static final String MEDIA_LOCATION_PROPERTY = "landcms.media-location";
